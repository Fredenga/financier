defmodule FinancierWeb.HomeDesc.HomeExp do
  ...
  def home_exp(assigns) do
    ~H"""
      <div class="w-1/2">
       <h1 class="text-5xl leading-normal font-[600]">An Experience That Expands to Fit Your Finance Size</h1>
       <p class="text-md text-gray-500 mt-5 mb-10">Automatically track your expenses, set budgets, and achieve your financial goals with AI-powered insights.</p>
